...
(
  ...
  always_comb begin
    case (vector_mode_i)
      ...
      // {shift_amt[15:0],shift_amt[31:16]}
  ...
  //op_A      = 32'b 0010_1010_0110_0000_1111_0101_1010_0111
  //bmask_inv = 32'b 1111_1111_0000_0000_0000_0000_1111_1111
  //bclr      = 32'b 0010_1010_0000_0000_0000_0000_1010_0111

  //op_A      = 32'b 0010_1010_0110_0000_1111_0101_1010_0111
  //bmask     = 32'b 0000_0000_1111_1111_1111_1111_0000_0000
  //bset      = 32'b 0010_1010_1111_1111_1111_1111_1010_0111
  ...
  generate
    // radix-2 bit reverse //1-bit by 1-bit
    for (j = 0; j < 32; j++) begin : gen_radix_2_rev
      assign radix_2_rev[j] = shift_result[31-j];
    end
    // radix-4 bit reverse //2-bit by 2-bit
    for (j = 0; j < 16; j++) begin : gen_radix_4_rev
      assign radix_4_rev[2*j+1:2*j] = shift_result[31-j*2:31-j*2-1];
    end
    // radix-8 bit reverse //3-bit by 3-bit
